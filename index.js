...
/////////////////
const BotName = 'Cen Bot☄'; 
const instagram = 'https://instagram.com/iincen_'; 
const telegram = 'https://t.me/incen'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/iincen';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@iincen_')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@iincen_`)
})
...
axios.get(`https://api.lolhuman.xyz/nulis?text=${teks}&apiKey=682aeab645ed61cf137cf971`).then((res) => {
...
axios.get(`https://api.lolhuman.xyz/api/yta?url=${teks}&apiKey=682aeab645ed61cf137cf971`).then((res) => {
...
axios.get(`https://api.lolhuman.xyz/api/ytv?url=${teks}&apiKey=682aeab645ed61cf137cf971`).then((res) => {
...
axios.get(`https://api.lolhuman.xyz/api/epbe?url=${teks}&apiKey=682aeab645ed61cf137cf971`).then((res) => {
...
axios.get(`https://api.lolhuman.xyz/api/ig?url=${teks}&apiKey=682aeab645ed61cf137cf971`).then((res) => {
    let hasil = `Berhasil! silahkan klik link di bawah untuk mendownload hasilnya!\n👇👇👇👇👇👇👇👇👇\n\nUkuran: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://api.lolhuman.xyz/api/twit?url=${teks}&apiKey=682aeab645ed61cf137cf971`).then((res) => {
...
axios.get(`https://api.lolhuman.xyz/api/wiki?q=${teks}&lang=id&apiKey=682aeab645ed61cf137cf971`).then((res) => {
...
if (text.includes("!sholat")){
  ...
  axios.get(`https://api.lolhuman.xyz/api/jadwalshalat?daerah=${teks}&apiKey=682aeab645ed61cf137cf971`).then ((res) =>{
